...
def zombieFight():
    ...
    if zombieHealth <= 0:  # if the zombie's health is 0 or less, ie the zombie is dead:
        print
        "Congratulations! You have successfully killed %s.\n\nYOUR HEALTH: %d" % (zombieName, userHealth)  # shows this
    else:
        ...
        if userHealth <= 0:  # if the user's health is 0 or less, ie the user is dead:
            ...
            print
            "He attacks you and inflicts %d damage.\n\nZOMBIE HEALTH: %d\n  YOUR HEALTH: %d" % (
    ...
    if knifeCount == 0:  # if the user doesn't have any knives
        ...
        while True:  # loops continuously until statement break
            ...
            if selection == "punch" or selection == "p":  # if selection is "punch" or "p"
                cls()
                print
                "You punch %s and inflict %d damage." % (zombieName, damage)  # shows this
                ...
                cls()
                print
                "You kick %s and inflict %d damage." % (zombieName, damage)  # shows this
                zombieHealth = zombieHealth - damage  # takes damage off zombieHealth
                break  # breaks the loop
            elif selection == "eyegouge" or selection == "eye-gouge" or selection == "e":  # if selection is "eyegouge" or "eye-gouge" or "e"
                cls()
                print
                "You eye-gouge %s and inflict %d damage." % (zombieName, damage)  # shows this
                zombieHealth = zombieHealth - damage  # takes damage off zombieHealth
                break  # breaks the loop
            else:
                selection = raw_input(
        ...
        while True:  # loops continuously until statement break
            ...
            if selection == "punch" or selection == "p":  # if selection is "punch" or "p"
                ...
                cls()
                print
                "You throw your knife at %s and inflict 25 damage." % zombieName  # shows this
...
def heal():
    ...
    cls()
    print
    "You heal yourself, and gain %s health." % (damage + 1)  # shows this
...
print
"Congratulations %s! You beat the zombies and won the game!" % username  # shows this
